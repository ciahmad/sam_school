                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <h4 class="session-head"><?php echo $this->lang->line('academic') . " " . $this->lang->line('business_setting'); ?></h4>
                                    </div><!--./col-md-12-->
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('business_type'); ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <?php if($result->business_type){
                                                    $readonly = 'readonly';
                                                    $style = 'background-color: #eee;';
                                                }else{ $readonly = ''; $style = ''; } ?>
                                                <select  id="business_type" name="sch_business_type" class="form-control" <?php echo $readonly;?> style="<?php echo $style;?>">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php if($result->business_type==1){?>
                                                        <option value="1" selected="selected" ><?php echo $this->lang->line('individual'); ?> </option>
                                                    <?php }else{ ?>
                                                        <option value="1" ><?php echo $this->lang->line('individual'); ?> </option>
                                                    <?php }?>
                                                    <?php if($result->business_type==2){?>
                                                        <option value="2" selected="selected" ><?php echo $this->lang->line('aop'); ?> </option>
                                                    <?php }else{ ?>
                                                        <option value="2" ><?php echo $this->lang->line('aop'); ?> </option>
                                                    <?php }?>
                                                    <?php if($result->business_type==3){?>
                                                        <option value="3" selected="selected" ><?php echo $this->lang->line('company'); ?> </option>
                                                    <?php }else{ ?>
                                                        <option value="3" ><?php echo $this->lang->line('company'); ?> </option>
                                                    <?php }?>
                                    ...
                                    <div class="col-md-6" id="reg_number_id" style="display:none" >
                                        <div class="form-group row">
                                            <label class="col-sm-4" id="label_reg_number"><?php echo $this->lang->line('reg_number'); ?></label>
                                            <div class="col-sm-8">
                                                <?php if($result->reg_number){
                                                    $readonly = 'readonly';
                                                    $style = 'background-color: #eee;';
                                                }else{
                                                    $readonly = '';
                                                ...
                                                <input type="text" class="form-control" id="reg_number" name="reg_number" value="<?php echo $result->reg_number; ?>" <?php echo $readonly;?> style="<?php echo $style;?>">
                                                <span class="text-danger"><?php echo form_error('reg_number'); ?></span> 
                                            </div>
                                        </div>
                                    </div>
                                    <div id="ind_user" style="display: none;">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-sm-4"><?php echo $this->lang->line('user_full_name'); ?><small class="req"> *</small></label>
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" id="user_name" name="user_name" value="<?php echo $result->user_name; ?>" <?php echo $readonly;?> style="<?php echo $style;?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-sm-4"><?php echo $this->lang->line('user_email'); ?><small class="req"> *</small></label>
                                                <div class="col-sm-8">
                                                    <?php if($result->user_email){
                                                        $readonly = 'readonly';
                                                        $style = 'background-color: #eee;';
                                                    }else{
                                                        $readonly = '';
                                                    ...
                                                    <input type="text" class="form-control" id="user_email" name="user_email" value="<?php echo $result->user_email; ?>" <?php echo $readonly;?> style="<?php echo $style;?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-sm-4"><?php echo $this->lang->line('user_phone'); ?><small class="req"> *</small></label>
                                                <div class="col-sm-8">
                                                    <?php if($result->user_phone){
                                                        $readonly = 'readonly';
                                                        $style = 'background-color: #eee;';
                                                    }else{
                                                        $readonly = '';
                                                    ...
                                                    <input type="text" class="form-control" id="user_phone" name="user_phone" value="<?php echo $result->user_phone; ?>" <?php echo $readonly;?> style="<?php echo $style;?>">
                                                    <span class="text-danger"><?php echo form_error('user_phone'); ?></span> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
                                    <div class="col-md-12" id="num_of_partner" style="display:none;">
                                        <div class="form-group row">
                                            <label class="col-sm-2"><?php echo $this->lang->line('no_of_partners'); ?><small class="req"> *</small></label>
                                            <div class="col-sm-1">
                                                <?php if($result->no_of_partners){
                                                    $readonly = 'readonly';
                                                    $style = 'background-color: #eee;';
                                                }else{
                                                    $readonly = '';
                                                ...
                                                <input type="text" class="form-control" id="no_of_partners" name="no_of_partners" value="<?php echo $result->no_of_partners; ?>" <?php echo $readonly;?> style="<?php echo $style;?>">
                                                <span class="text-danger"><?php echo form_error('no_of_partners'); ?></span> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12" id="num_of_director" style="display:none;">
                                        <div class="form-group row">
                                            <label class="col-sm-2"><?php echo $this->lang->line('no_of_directors'); ?><small class="req"> *</small></label>
                                            <div class="col-sm-1">
                                                <?php if($result->no_of_directors){
                                                    $readonly = 'readonly';
                                                    $style = 'background-color: #eee;';
                                                }else{
                                                    $readonly = '';
                                                ...
                                                <input type="text" class="form-control" id="no_of_directors" name="no_of_directors" value="<?php echo $result->no_of_directors; ?>" <?php echo $readonly;?> style="<?php echo $style;?>">
                                                <span class="text-danger"><?php echo form_error('no_of_directors'); ?></span> 
                                            </div>
                                        </div>
                                    </div>  
                                    <div id="busiTerm">
                                        <?php if ($busiTerms) { $readonly = 'readonly';
                                                    $style = 'background-color: #eee;'; ?>
                                            <?php foreach ($busiTerms as $key => $busiTerm) { ?>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-4"><?php echo $busiTerm['name'] ; ?><small class="req"> *</small></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="<?php echo $busiTerm['textfield_name'] ; ?>" name="<?php echo $busiTerm['textfield_name'] ; ?>" value="<?php echo $busiTerm['value'] ;?>" <?php echo $readonly;?> style="<?php echo $style;?>">
                                    ...
                                    <div id="busi_partners"></div>
                                    <div id="busi_directors"></div>
...
<script type="text/javascript">
    ...
    $("#no_of_partners").change(function(){
        $("#busiTerm").hide();
        $("#no_of_directors").val('');
      var noOfPartners = $("#no_of_partners").val();
        var phtml ='';
        for (var i = 1; i <= noOfPartners; i++) {
            phtml +='<div class="col-md-6"><div class="form-group row"><label class="col-sm-4">Partner Name-'+ i +'<small class="req"> *</small></label><div class="col-sm-8"><input type="text" class="form-control" id="partner_name'+ i +'" name="partner_name'+ i +'" value=""><span class="text-danger"></span></div></div></div><div class="col-md-6"><div class="form-group row"><label class="col-sm-4">% of Shares-'+i+'<small class="req"> *</small></label><div class="col-sm-8"><input type="text" class="form-control" id="shares'+i+'" name="part_shares'+ i +'" value=""><span class="text-danger"></span></div></div></div>';
        }
        $("#busi_partners").html(phtml);
    });

    $("#no_of_directors").change(function(){
        $("#busiTerm").hide();
        $("#no_of_partners").val('');
      var noOfDirectors = $("#no_of_directors").val();
        var dhtml ='';
        for (var i = 1; i <= noOfDirectors; i++) {
            dhtml +='<div class="col-md-6"><div class="form-group row"><label class="col-sm-4">Director Name-'+ i +'<small class="req"> *</small></label><div class="col-sm-8"><input type="text" class="form-control" id="director_name'+ i +'" name="director_name'+ i +'" value=""><span class="text-danger"></span></div></div></div><div class="col-md-6"><div class="form-group row"><label class="col-sm-4">% of Shares-'+i+'<small class="req"> *</small></label><div class="col-sm-8"><input type="text" class="form-control" id="dir_shares'+i+'" name="dir_shares'+ i +'" value=""><span class="text-danger"></span></div></div></div>';
        }
        $("#busi_directors").html(dhtml);
    });

    $(document).ready(function(){

        var busiTerms = '<?php echo  $busiTermsId;?>';
        ...
        if(busiTerms == 0){
            ...
            //         html +='<div class="col-md-6"><div class="form-group row"><label class="col-sm-4">Director Name-'+ i +'<small class="req"> *</small></label><div class="col-sm-8"><input type="text" class="form-control" id="director_name'+ i +'" name="director_name'+ i +'" value=""><span class="text-danger"></span></div></div></div><div class="col-md-6"><div class="form-group row"><label class="col-sm-4">% of Shares-'+i+'<small class="req"> *</small></label><div class="col-sm-8"><input type="text" class="form-control" id="dir_shares'+i+'" name="dir_shares'+ i +'" value=""><span class="text-danger"></span></div></div></div>';
            //     }
            //     $("#busi_directors").html(html);
            // }
        }

        $("#label_reg_number").html('Reg. Number / NTN <small class="req"> *</small>');
        //var business_type =  '<?php echo $result->business_type;?>';
        //var no_of_partners =  '<?php echo $result->no_of_partners;?>';
        //alert(business_type);
        if(business_type!=''){
            ...
            if(business_type == 1){
                ...
                $("#ind_user").show();
                $("#num_of_partner").hide();
                $("#num_of_director").hide();
                $("#busi_partners").empty();
                $("#busi_directors").empty();

            }else if(business_type == 2){
                $("#reg_number_id").show();
                $("#num_of_partner").show();
                $("#num_of_director").hide();
                $("#label_reg_number").html('Firm Reg. Number <small class="req"> *</small>');
                $("#ind_user").hide();
                $("#busi_directors").empty();
                ...
                $("#reg_number_id").show();
                $("#num_of_partner").hide();
                $("#num_of_director").show();
                $("#label_reg_number").html('Comp Reg. Number <small class="req"> *</small>');
                $("#ind_user").hide();
                $("#busi_partners").empty();
