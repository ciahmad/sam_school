                        ...
                        <form action="<?php echo site_url("admin/expense/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="exp_head_id" name="exp_head_id" class="form-control" >
                                        ...
                                        foreach ($expheadlist as $exphead) {
                                            ?>
                                            <option value="<?php echo $exphead['account_id'] ?>"<?php
                                            if ($expense['exp_head_id'] == $exphead['account_id']) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="invoice_no" name="invoice_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('invoice_no', $expense['invoice_no']); ?>" readonly style="background-color: #dddddd94;"/>
