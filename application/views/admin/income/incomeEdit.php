                        ...
                        <form action="<?php echo site_url("admin/income/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="inc_head_id" name="inc_head_id" class="form-control" >
                                        ...
                                        foreach ($incheadlist as $inchead) {
                                            ?>
                                            <option value="<?php echo $inchead['account_id'] ?>"<?php
                                            if ($income['inc_head_id'] == $inchead['account_id']) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="invoice_no" name="invoice_no" placeholder="" type="text" class="form-control"  value="<?php echo $income['invoice_no']; ?>" readonly style="background-color: #dddddd94;" />
