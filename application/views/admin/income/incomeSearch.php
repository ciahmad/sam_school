...
<div class="content-wrapper" style="min-height: 946px;">
                    ...
                    <?php if (isset($resultList)) {
                        ...
                        <div class="" id="exp">
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('income_result'); ?>
                                
                                 <div class="box-header ptbnull" style="text-align:right; float:right">
                            
                                        <?php
                                                 $filename = 'temp/income.png';
    ...
    if (isset($_REQUEST['size']))
        $matrixPointSize = min(max((int)$_REQUEST['size'], 1), 10);
                                       ...
                                       //default data  
        QRcode::png('Income Report', $filename, $errorCorrectionLevel, $matrixPointSize, 2);    
