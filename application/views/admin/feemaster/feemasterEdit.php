                                     ...
                                     <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="fee_payment_type" class="form-control">
                                                <option value="1" <?php if($feegroup_type->fee_payment_type =="1"){ ?> selected:selected <?php } ?>>One Time</option>
                                                 <option value="2" <?php if($feegroup_type->fee_payment_type =="2"){ ?> selected:selected <?php } ?>>Re-Curring</option>
                                            </select>
                                        </div>
                                    </div>   
                                                ...
                                                <td class="mailbox-name">
                                                    <ul class="liststyle1">
                                                        ...
                                                        foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                            ?>
                                                            <li>
                                                                <?php echo $this->feetype_model->FeetypeByName($feetype_value->feetype_id)->type; ?> &nbsp;&nbsp;
