                        ...
                        <div class="<?php echo $bgoffsetbg; ?>">   
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                                <div class="loginbg loginradius login390">  
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        <form action="<?php echo site_url('site/login') ?>" method="post">
                                            ...
                                            <div class="form-group has-feedback">                                            
                                                <input type="text" name="username" placeholder="<?php echo $this->lang->line('username'); ?>" value="info@1pixelcoding.com" class="form-username form-control" id="form-username">
                                                <span class="fa fa-envelope form-control-feedback"></span>
                                                <span class="text-danger"><?php echo form_error('username'); ?></span>
                                            </div>
                                            <div class="form-group has-feedback">                                           
                                                <input type="password" value="123456" name="password" placeholder="<?php echo $this->lang->line('password'); ?>" class="form-password form-control" id="form-password">
                                    ...
                                    <h3>Demo User Details <br></h3><h4>Email: info@1pixelcoding.com<br>Password: 123456</h4>
                                    </div>
                                </div>
                            </div>
                            <?php
