                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right"><a style="float: right;" href="<?php echo base_url(); ?>admin/account/getall"><i class="fa fa-backward"></i>Back</a></div>
                        </div>
                    ...
                    <form id="form1" action="<?php echo site_url($posturl) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="account_number" name="account_number" placeholder="" type="text" class="form-control"  value="<?php echo $editaccount['account_number']; ?>" />
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="closing_balance" name="closing_balance" placeholder="" type="text" class="form-control"  value="<?php if($editaccount['closing_balance'] > 0 ){ echo $editaccount['closing_balance'];}else{ echo $closing_balance;} ?>" />
