                    ...
                    <div class="col-lg-8 col-md-9 col-sm-10 col-xs-7">
                        ...
                        <div class="pull-right">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="javascript:"><i class="fa fa-home ftlayer"></i><span style="padding-left: 5px;">HOME</span></a></li>
                                <li><a href="<?php echo base_url(); ?>admin/admin/dashboard"><i class="fa fa-dashboard ftlayer"></i><span style="padding-left: 5px;">DASHBOARD</span></a></li>
                            </ul>
