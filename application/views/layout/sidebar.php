...
<aside class="main-sidebar" id="alert2">
    ...
    <section class="sidebar" id="sibe-box">
                    ...
                    <ul style="padding-left: 5px; <?php echo menu_heading('SETTINGS'); ?>">
                        ...
                        <li> <a href="javascript:"><i class="fa fa-map-o ftlayer"></i>EXAMINATIONS</a>
                            ...
                            <ul style="padding-left: 5px; <?php echo sub_heading('Question Bank'); ?>">
                                ...
                                <li><a href="<?php echo base_url(); ?>admin/question" style="<?php echo set_1stLevel('Online_Examinations/question'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('objective')." ".$this->lang->line('question'); ?></a></li>
                                <?php
                                    }
                                ?> 
                                
                                <?php if ($this->rbac->hasPrivilege('question_bank', 'can_view')) { ?>
                                <li><a href="<?php echo base_url(); ?>admin/subjectivequestion" style="<?php echo set_1stLevel('Online_Examinations/subjective'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('subjective'). " " .$this->lang->line('question'); ?></a></li>
                                <?php
                                    }
                                ?> 
                                ...
                                <li><a href="<?php echo base_url(); ?>admin/generatepaper" style="<?php echo set_1stLevel('Online_Examinations/generatepaper'); ?>"><i class="fa fa-angle-double-right"></i>Paper Generate </a></li>
                                <?php
                                    }
                                ?> 
                            </ul>
        ...
        <img src="<?php echo base_url(); ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo();?>" alt="<?php echo $this->customlib->getAppName() ?>" style="padding-left: 4px;width: 200px;position: fixed;height: 40px;bottom: 0px;left: 0px;" />
    </section>
