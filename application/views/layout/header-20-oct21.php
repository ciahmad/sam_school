                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="col-lg-5 col-md-3 col-sm-2 col-xs-5">
                        <ul class="nav navbar-nav">
                              ...
                              <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">FRONT OFFICE
                                <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                  <li class="<?php echo set_Submenu('admin/enquiry'); ?>"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" href="<?php echo base_url(); ?>admin/enquiry"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('admission_enquiry'); ?> </a></li>
                                  <li class="<?php echo set_Submenu('admin/visitors'); ?>"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" href="<?php echo base_url(); ?>admin/visitors"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('visitor_book'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/generalcall'); ?>"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" href="<?php echo base_url(); ?>admin/generalcall"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('phone_call_log'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/dispatch'); ?>"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" href="<?php echo base_url(); ?>admin/dispatch"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('postal_dispatch'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/receive'); ?>"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" href="<?php echo base_url(); ?>admin/receive"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('postal_receive'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/complaint'); ?>"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" href="<?php echo base_url(); ?>admin/complaint"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('complain'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/visitorspurpose'); ?>"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" href="<?php echo base_url(); ?>admin/visitorspurpose"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('setup_front_office'); ?></a></li>
                                </ul>
                              </li>
                              <li class="dropdown">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-10 col-xs-7">
